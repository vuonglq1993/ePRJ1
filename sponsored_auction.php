                    ...
                    <div class="row">
                        <div class="p-2">
                            ...
                            <a class="nav-link fw-bold" href="trending_auction.php" style="color: #666666" ;>Trending Auctions</a>
                                ...
                                <a class="nav-link fw-bold active" href="#" aria-current="page" style="color: #666666" ;>Sponsored
                                    auction</a>
                                <a class="nav-link  fw-bold"  href="incoming_auction.php">Incoming auction</a>
                                <a class="nav-link fw-bold" href="fav_seller.php" style="color: #666666" ;>Completed
                                    auction</a>
                            </nav>
                        </div>
                    </div>
