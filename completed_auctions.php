                ...
                <div class="col-11">
                    <div class="row">
                        <div class="p-2">
                            ...
                            <p class="fs-3 ps-3">Completed auctions</p>
                            <nav class="nav">
                                ...
                                <a class="nav-link fw-bold active" href="sponsored_auctions.php"
                                    style="color: #666666;">Sponsored auctions</a>
                                <a class="nav-link fw-bold" href="incoming_auctions.php"
                                    style="color: #666666;">Incoming auctions</a>
