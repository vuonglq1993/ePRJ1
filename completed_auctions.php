                    ...
                    <div class="row">
                        <div class="p-2">
                            ...
                            <nav class="nav">
                                ...
                                <a class="nav-link fw-bold" href="trending_auctions.php"
                                    style="color: #666666;">Trending Auctions</a>
                                <a class="nav-link fw-bold active" href="sponsored_auctions.php"
                                    style="color: #666666;">Sponsored auction</a>
                                <a class="nav-link fw-bold" href="completed_auctions.php"
                                    style="color: #666666;">Incoming auction</a>

                                <a class="nav-link fw-bold" href="#" aria-current="page">Completed auctions</a>
                            </nav>
                        </div>
                    </div>
                                ...
                                foreach ($completed_auctions as $auction) {
                                    ...
                                    <div class="col-md-3 col-sm-11 me-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <a href="categories3.php?product_id=<?php echo htmlspecialchars($product_id); ?>"><img
                                            ...
                                            <div class="row text-center">
                                                <a href="bid_details.php?auction_id=<?php echo htmlspecialchars($auction_id) ?>"
                                                    ...
                                                    <?php echo htmlspecialchars($bid_display); ?>
                                                    <?php echo format_price2($current_bid); ?>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
