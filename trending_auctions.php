                    ...
                    <div class="row">
                        <div class="p-2">
                            ...
                            <nav class="nav">
                                ...
                                <a class="nav-link fw-bold" href="sponsored_auctions.php" style="color: #666666"
                                    ;>Sponsored
                                    auction</a>
                                <a class="nav-link fw-bold" href="incoming_auctions.php">Incoming auction</a>
                                <a class="nav-link fw-bold" href="completed_auctions.php" style="color: #666666"
                                    ;>Completed
                                    auction</a>
                            </nav>
                        </div>
