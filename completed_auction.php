                ...
                <div class="col-11">
                    <div class="row">
                        <div class="p-2">
                            ...
                            <nav class="nav">
                                <a class="nav-link fw-bold" href="trending_auction.php" style="color: #666666" ;>Trending auction</a>
                                    <a class="nav-link fw-bold" href="sponsored_auction.php" style="color: #666666" ;>Sponsored
                                    auction</a>
                                <a class="nav-link  fw-bold "  href="incoming_auction.php">Incoming auction</a>
                                <a class="nav-link fw-bold active" aria-current="page" href="#" style="color: #666666" ;>Completed
                                    auction</a>
                            </nav>
                        </div>
                    </div>
