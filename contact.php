                    ...
                    <div class="row">
                        <div class="col-4 my-5">
                            <ul>
                                ...
                                <li class="list-group-item">
                                    <p class="fs-6 mt-0"><i class="bi bi-telephone fs-5 me-2"></i> +84 241133119

                                    </p>
                                </li>
                                <li class="list-group-item">
                                    <p class="fs-6 mt-0"><i class="bi bi-telephone fs-5 me-2"></i> +84 824010101
                                    </p>
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li class="list-group-item">
                                    <p class="fs-6 mt-0"><i class="bi bi-envelope fs-5 me-2"></i>
                                        bidspirit@gmail.com
                        ...
                        <div class="col-8 mt-5">
                            <p class="fs-6 fw-bold text-center mb-5">Contact us in the way most convenient for you, we are ready to answer all
                                your questions. </p>
                            <div class="mb-3">
